...
class ShimmerWidget extends StatelessWidget {
  const ShimmerWidget({super.key, required this.shimmerWidth, required this.shimmerHieght, required this.shimmerRadius, this.shimmerText});
  ...
  Widget _buildShimmerLine(
    ...
    return Shimmer.fromColors(
      ...
      child: Container(
        ...
        child: ReusableText(text: "not data" , style:appStyle(16, Colors.black, FontWeight.bold,
        ),
        ),
      ),
    );
